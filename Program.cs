...
namespace HttpClientUsingTcp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("HTTPtron (c) 2020 Witherman17 Software, all rights reserved.");
            Console.WriteLine("Version 1.0, build 001");
        ...
        public static async Task<string> RequestHtmlAsync(string hostname)
        {
            ...
            catch (SocketException ex)
            {
                ...
                Console.WriteLine("This website may be HTTPS, or it may not exist at all.");
                return null;
            }
        }
    }
